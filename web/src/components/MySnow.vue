    ...
    canvas() {
      ...
      window.requestAnimFrame = (function () {
        return (
          ...
          window.webkitRequestAnimationFrame || //谷歌、Safari
          window.mozRequestAnimationFrame || //火狐
      ...
      Canvas.prototype = {
        resize(booleam) {
          ...
          //Element.clientWidth 属性表示元素的内部宽度，以像素计。该属性包括内边距 padding，但不包括边框 border、外边距 margin
